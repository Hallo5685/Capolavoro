...
public class Tpsit {
    public static void main(String[] args) {
        ...
        String scelta2 = null;
        int sceltaNum = 0;
        String rigioca = new String();

        System.out.println("Vuoi cominciare a giocare? inserire si o no");
        rigioca=input.next();
        if(!rigioca.equalsIgnoreCase("si") && !rigioca.equalsIgnoreCase("no") ){
            do{
                System.out.println("Scelta non valida, reinserire");
                rigioca=input.next();
            }while(!rigioca.equalsIgnoreCase("si") && !rigioca.equalsIgnoreCase("no"));
        }
        while(rigioca.equalsIgnoreCase("si")) {
            ...
            System.out.println("Desidera scommettere su altro? Digitare si o no");
            scelta1 = input.next();
            ...
            System.out.println("Su quante ruote vuole puntare i numeri scommessi? può selezionare  solamente 1 o  tutte e 10 ");
            ...
            if (SceltaRuota == 1) {
                switch (sceltaNum) {
                    case 1:
                        System.out.println("La tua probabilità di vincere con i numeri scommessi era di 1 su 18");
                        break;

                    case 2:
                        System.out.println("La tua probabilità di vincere con i numeri scommessi era di 1 su 400");
                        break;


                    case 3:
                        System.out.println("La tua probabilità di vincere con i numeri scommessi era di 1 su 11748");
                        break;

                    case 4:
                        System.out.println("La tua probabilità di vincere con i numeri scommessi era di 1 su 511.038 ");
                        break;

                    case 5:
                        System.out.println("La tua probabilità di vincere con i numeri scommessi era di 1 su 43.949.268");
                        break;
                }
            } else {
                switch (sceltaNum) {
                    case 1:
                        System.out.println("La tua probabilità di vincere con i numeri scommessi era di 1 su 18  su ogni ruota");
                        break;

                    case 2:
                        System.out.println("La tua probabilità di vincere con i numeri scommessi era di 1 su 400 su ogni ruota");
                        break;


                    case 3:
                        System.out.println("La tua probabilità di vincere con i numeri scommessi era di 1 su 11748 su ogni ruota");
                        break;

                    case 4:
                        System.out.println("La tua probabilità di vincere con i numeri scommessi era di 1 su 511.038 su ogni ruota");
                        break;

                    case 5:
                        System.out.println("La tua probabilità di vincere con i numeri scommessi era di 1 su  43.949.268 su ogni ruota");
                        break;
                }
            }
            System.out.println("Vuoi rigiocare? inserire si o no");
            rigioca=input.next();
            if(!rigioca.equalsIgnoreCase("si") && !rigioca.equalsIgnoreCase("no") ){
                do{
                    System.out.println("Scelta non valida, reinserire");
    ...
    private static int [] Menu(Scanner input)
    {
        ...
        System.out.println("BENVENUTI AL GIOCO DEL LOTTO");
        ...
        while(sceltaNum < 1 || sceltaNum > 5){
            ...
            System.out.println("Il numero che hai inserito non è valido, puoi scommettere solo da 1 a 5!");
        ...
        for(int i = 0; i < sceltaNum; i++){
            ...
            System.out.println("Inserisci il " +(i+1)+ "° numero compreso fra 1 e 90 (premere invio dopo aver digitato il numero) ");
